...
build_module mailoney --build-arg HONEYPOT_BASE_IMAGE=python:3.11-slim
build_module honeypy --build-arg HONEYPOT_BASE_IMAGE=python:3.11-slim
build_module glutton --build-arg HONEYPOT_BASE_IMAGE=golang:1.23-bookworm
