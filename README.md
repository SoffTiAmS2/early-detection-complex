...
```text
center/     # веб-интерфейс, API, установка сенсоров, хранилище событий
...
```sh
python3 -m compileall center/server.py sensor/agent.py sensor/runtime.py tools/validate_policy.py tools/e2e_reconfigure_test.py
