...
def desired_state(policy: dict[str, Any], catalog: dict[str, Any], sensor_id: str) -> dict[str, Any] | None:
    ...
    return {
        ...
        "config_version": int(desired.get("config_version", policy.get("version", 1))),
        "site": policy.get("site", {}),
        "host": sensor.get("host"),
        "architecture": sensor.get("architecture"),
        "active_profile": desired.get("active_profile", desired.get("profile")),
        "profile": desired.get("profile"),
        "profile_name": desired.get("profile_name"),
        "device_type": desired.get("device_type"),
        "runtime_mode": desired.get("runtime_mode", "docker"),
        "persona": desired.get("persona", {}),
        "legend": desired.get("legend", desired.get("persona", {})),
        "exposed_ports": desired.get("exposed_ports", []),
        "honeypots": desired.get("honeypots", []),
        "banners": desired.get("banners", {}),
        "service_fingerprints": desired.get("service_fingerprints", {}),
        "docker_template": desired.get("docker_template", {}),
        "config_templates": desired.get("config_templates", {}),
        "resource_limits": desired.get("resource_limits", {}),
