...
def sensor_status_event(
    ...
    return {
        ...
        "config_version": desired.get("config_version") if desired else status.get("config_version"),
        "active_profile": desired.get("active_profile") if desired else status.get("active_profile"),
        "profile": desired.get("profile") if desired else status.get("profile"),
        "device_type": desired.get("device_type") if desired else status.get("device_type"),
